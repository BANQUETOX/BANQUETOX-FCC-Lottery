...
error Lottery__UpKeepNeeded(uint256 currentBalance, uint256 numPlayers, uint256 lotteryState);

/**@title A sample lottery contract
 * @author BANQUETA
 * @notice This contract is for a untamperable decentralized lottery
 * @dev This implements chainlink VRF v2 and chainlik keepers
 */
